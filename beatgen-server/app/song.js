...
module.exports.playAccentThisSong = playAccentThisSong  

var playHeyThisSong;
module.exports.playHeyThisSong = playHeyThisSong  
...
module.exports.isLugerMode = isLugerMode  

function isMustardMode() {
	return false;
}
module.exports.isMustardMode = isMustardMode  

function isLondonMode() {
	return false;
}
module.exports.isLondonMode = isLondonMode  

function isZayMode() {
	return false;
}
module.exports.isZayMode = isZayMode  

function isChordsMode() {
	return false;
}
module.exports.isChordsMode = isChordsMode  

function isChillhopMode() {
	return false;
}
module.exports.isChillhopMode = isChillhopMode  

const beatpart = require('./beatpart')
const bass = require('./bass')
var key = bass.key
var minor = bass.minor
...
function Song() {
    ...
    this.aSection = new beatpart.BeatPart(true);
    this.bSection = beatpart.mutateBeatPart(this.aSection)
